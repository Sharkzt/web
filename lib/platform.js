...
if(typeof(platform.os.family) == 'undefined' || platform.os.family === null) {
...
document.body.setAttribute('data-os', platform.os.family);

document.body.setAttribute('data-browser', platform.name);
